  ...
  return (
    <div className="session">
      <div className="left" style={{ 
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/access-denied.jpg')` 
      }}>
      ...
      <div className="log-in">
        ...
        <p className="welcome-message">You do not have permission to view this page.</p>
